...
def match_logline_pairs(log_recs):
    ...
    for idx in range(len(log_recs)-2):
        for idx2 in range(idx+1, len(log_recs)-1):
            print("matching rec %d to %d" % (idx, idx2))
