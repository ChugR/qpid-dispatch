...
{
  if (event == QDRC_EVENT_CONN_OPENED) return "QDRC_EVENT_CONN_OPENED";
  if (event == QDRC_EVENT_CONN_CLOSED) return "QDRC_EVENT_CONN_CLOSED";
  if (event == QDRC_EVENT_CONN_EDGE_ESTABLISHED) return "QDRC_EVENT_CONN_EDGE_ESTABLISHED";
  if (event == QDRC_EVENT_CONN_EDGE_LOST) return "QDRC_EVENT_CONN_EDGE_LOST";
  if (event == QDRC_EVENT_CONN_IR_ESTABLISHED) return "QDRC_EVENT_CONN_IR_ESTABLISHED";
  if (event == QDRC_EVENT_CONN_IR_LOST) return "QDRC_EVENT_CONN_IR_LOST";
  if (event == QDRC_EVENT_LINK_IN_ATTACHED) return "QDRC_EVENT_LINK_IN_ATTACHED";
  if (event == QDRC_EVENT_LINK_IN_DETACHED) return "QDRC_EVENT_LINK_IN_DETACHED";
  if (event == QDRC_EVENT_LINK_OUT_ATTACHED) return "QDRC_EVENT_LINK_OUT_ATTACHED";
  if (event == QDRC_EVENT_LINK_OUT_DETACHED) return "QDRC_EVENT_LINK_OUT_DETACHED";
  if (event == QDRC_EVENT_LINK_EDGE_DATA_ATTACHED) return "QDRC_EVENT_LINK_EDGE_DATA_ATTACHED";
  if (event == QDRC_EVENT_LINK_EDGE_DATA_DETACHED) return "QDRC_EVENT_LINK_EDGE_DATA_DETACHED";
  if (event == QDRC_EVENT_ADDR_ADDED) return "QDRC_EVENT_ADDR_ADDED";
  if (event == QDRC_EVENT_ADDR_REMOVED) return "QDRC_EVENT_ADDR_REMOVED";
  if (event == QDRC_EVENT_ADDR_BECAME_LOCAL_DEST) return "QDRC_EVENT_ADDR_BECAME_LOCAL_DEST";
  if (event == QDRC_EVENT_ADDR_NO_LONGER_LOCAL_DEST) return "QDRC_EVENT_ADDR_NO_LONGER_LOCAL_DEST";
  if (event == QDRC_EVENT_ADDR_BECAME_DEST) return "QDRC_EVENT_ADDR_BECAME_DEST";
  if (event == QDRC_EVENT_ADDR_NO_LONGER_DEST) return "QDRC_EVENT_ADDR_NO_LONGER_DEST";
  if (event == QDRC_EVENT_ADDR_ONE_LOCAL_DEST) return "QDRC_EVENT_ADDR_ONE_LOCAL_DEST";
  if (event == QDRC_EVENT_ADDR_TWO_DEST) return "QDRC_EVENT_ADDR_TWO_DEST";
  if (event == QDRC_EVENT_ADDR_BECAME_SOURCE) return "QDRC_EVENT_ADDR_BECAME_SOURCE";
  if (event == QDRC_EVENT_ADDR_NO_LONGER_SOURCE) return "QDRC_EVENT_ADDR_NO_LONGER_SOURCE";
  if (event == QDRC_EVENT_ADDR_TWO_SOURCE) return "QDRC_EVENT_ADDR_TWO_SOURCE";
  if (event == QDRC_EVENT_ADDR_ONE_SOURCE) return "QDRC_EVENT_ADDR_ONE_SOURCE";
  if (event == QDRC_EVENT_ROUTER_ADDED) return "QDRC_EVENT_ROUTER_ADDED";
  if (event == QDRC_EVENT_ROUTER_REMOVED) return "QDRC_EVENT_ROUTER_REMOVED";
  if (event == QDRC_EVENT_ROUTER_MOBILE_FLUSH) return "QDRC_EVENT_ROUTER_MOBILE_FLUSH";
  if (event == QDRC_EVENT_ROUTER_MOBILE_SEQ_ADVANCED) return "QDRC_EVENT_ROUTER_MOBILE_SEQ_ADVANCED";
  assert (false);
  return "unknown";
}
